...
public class InstallSetup
{
    public static void Main()
    {
        using (SqlConnection connection = new SqlConnection(Configuration.ConnectionString))
        {
            ...
            string tableEvilFactory = "CREATE TABLE EvilnessFactors(Id INT PRIMARY KEY IDENTITY, Name VARCHAR(50))";
            ...
            ExecNonQuery(connection, insertContires);
            ExecNonQuery(connection, insertTowns);
            ExecNonQuery(connection, insertMinions);
            ExecNonQuery(connection, insertEvilFactory);
            ExecNonQuery(connection, insertVillians);
            ExecNonQuery(connection, insertMinVil);
